...
|---|---|---|
| `ts/` | @voxgig-sdk/ip-proxy-detection-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/ip-proxy-detection-sdk \
      --repository voxgig-sdk/ip-proxy-detection-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/ip-proxy-detection-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/ip-proxy-detection-sdk --id=<id>` removes one.
