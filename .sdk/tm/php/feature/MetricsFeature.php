...
// IpProxyDetection SDK metrics feature
...
class IpProxyDetectionMetricsFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _record(IpProxyDetectionContext $ctx, bool $ok): void
    {
