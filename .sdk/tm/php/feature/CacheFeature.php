...
// IpProxyDetection SDK cache feature
...
class IpProxyDetectionCacheFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _through(IpProxyDetectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
