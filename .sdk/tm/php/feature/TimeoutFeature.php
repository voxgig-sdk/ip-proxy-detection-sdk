...
// IpProxyDetection SDK timeout feature
...
class IpProxyDetectionTimeoutFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _with_timeout(IpProxyDetectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpProxyDetectionContext $_ctx, float $ms): void
    {
        $client = $this->client;
