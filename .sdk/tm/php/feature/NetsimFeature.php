...
// IpProxyDetection SDK netsim feature
...
class IpProxyDetectionNetsimFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _simulate(IpProxyDetectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpProxyDetectionContext $ctx, array $applied): void
    {
        $client = $this->client;
