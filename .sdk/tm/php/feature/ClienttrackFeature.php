...
// IpProxyDetection SDK clienttrack feature
...
class IpProxyDetectionClienttrackFeature extends IpProxyDetectionBaseFeature
{
    ...
    public function PostConstruct(IpProxyDetectionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpProxyDetection-SDK';
