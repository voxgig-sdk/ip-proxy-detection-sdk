...
// IpProxyDetection SDK streaming feature
...
class IpProxyDetectionStreamingFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _iterate(IpProxyDetectionResult $result): \Generator
    {
    ...
    private function _streamable(IpProxyDetectionContext $ctx): bool
    {
