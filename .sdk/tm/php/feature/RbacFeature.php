...
// IpProxyDetection SDK rbac feature
...
class IpProxyDetectionRbacFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _required(IpProxyDetectionContext $ctx): ?string
    {
    ...
    private function _reject(IpProxyDetectionContext $ctx, string $required): void
    {
    ...
    private function _track(IpProxyDetectionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
