...
// IpProxyDetection SDK audit feature
...
class IpProxyDetectionAuditFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _emit(IpProxyDetectionContext $ctx, string $outcome): void
    {
