...
// IpProxyDetection SDK telemetry feature
...
class IpProxyDetectionTelemetryFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _close(IpProxyDetectionContext $ctx, bool $ok): void
    {
