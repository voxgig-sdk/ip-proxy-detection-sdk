...
// IpProxyDetection SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IpProxyDetectionOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IpProxyDetectionOmni::structfix($now, Struct::undef()))
                        !== json_encode(IpProxyDetectionOmni::structfix($val, Struct::undef()))) {
