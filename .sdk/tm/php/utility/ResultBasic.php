...
// IpProxyDetection SDK utility: result_basic

class IpProxyDetectionResultBasic
{
    public static function call(IpProxyDetectionContext $ctx): ?IpProxyDetectionResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof IpProxyDetectionError) ? $result->err->msg : (string)$result->err;
