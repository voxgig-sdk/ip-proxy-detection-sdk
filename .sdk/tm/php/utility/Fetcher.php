...
class IpProxyDetectionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpProxyDetectionSDK/1.0)';
    ...
    public static function call(IpProxyDetectionContext $ctx, string $fullurl, array $fetchdef): array
    {
