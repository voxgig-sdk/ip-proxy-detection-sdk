...
// IpProxyDetection SDK utility: graphql
//
...
class IpProxyDetectionGraphql
{
    ...
    // equivalent.
    public static function body(IpProxyDetectionContext $ctx): mixed
    {
    ...
    public static function errors(IpProxyDetectionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
