// Command IpProxyDetection-mcp is an MCP server exposing the IpProxyDetection
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpProxyDetection_list  — list records of an entity
//	IpProxyDetection_load  — load a single record of an entity
//
