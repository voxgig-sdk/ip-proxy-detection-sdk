...
from ipproxydetection_sdk.utility import register

# Load features
from ipproxydetection_sdk.feature.base_feature import IpProxyDetectionBaseFeature
from ipproxydetection_sdk.features import _has_feature, _make_feature
...
class IpProxyDetectionSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = IpProxyDetectionUtility()
        self._utility = utility

        from ipproxydetection_sdk.config import shared_config
    ...
    def get_utility(self):
        return IpProxyDetectionUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpProxyDetectionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Check(self, data=None) -> "CheckEntity":
        ...
        from ipproxydetection_sdk.entity.check_entity import CheckEntity
