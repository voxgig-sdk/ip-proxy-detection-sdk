# IpProxyDetection SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpProxyDetectionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpProxyDetectionSDK(...) and IpProxyDetectionSDK.test(...) become
#      IpProxyDetectionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipproxydetection_sdk"
_SDK_CLASS = "IpProxyDetectionSDK"
