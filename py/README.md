# IpProxyDetection Python SDK



The Python SDK for the IpProxyDetection API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Check()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ip-proxy-detection-sdk/releases)) or
...
```
py/
├── ipproxydetection_sdk.py         -- Main SDK module
