...
class CheckEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set IP_PROXY_DETECTION_TEST_CHECK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def check_basic_setup(extra)
  ...
  entid_env_raw = ENV["IP_PROXY_DETECTION_TEST_CHECK_ENTID"]
