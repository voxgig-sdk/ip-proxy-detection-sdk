...
#      offline in seeded test mode (IpProxyDetectionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpProxyDetection_sdk.rb")
  SDK_CLASS = "IpProxyDetectionSDK"
