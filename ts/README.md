# IpProxyDetection TypeScript SDK



The TypeScript SDK for the IpProxyDetection API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Check()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `IpProxyDetectionSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `IpProxyDetectionSDK.test(testopts?, sdkopts?)` | `IpProxyDetectionSDK` | Create a test-mode client. |
...
| `client` | `client(): IpProxyDetectionSDK` | Return the parent SDK client. |
...
ip-proxy-detection/
├── src/
│   ├── IpProxyDetectionSDK.ts        # Main SDK class
