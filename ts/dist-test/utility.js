...
function envOverride(m) {
    if ('TRUE' === process.env.IP_PROXY_DETECTION_TEST_LIVE ||
        'TRUE' === process.env.IP_PROXY_DETECTION_TEST_OVERRIDE) {
    ...
    m.IP_PROXY_DETECTION_TEST_EXPLAIN = process.env.IP_PROXY_DETECTION_TEST_EXPLAIN || m.IP_PROXY_DETECTION_TEST_EXPLAIN;
    return m;
}
