...
(0, node_test_1.describe)('CheckDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpProxyDetectionSDK({
    ...
    (0, node_test_1.test)('direct-load-check', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-check', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_PROXY_DETECTION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpProxyDetectionSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IP_PROXY_DETECTION_TEST_CHECK_ENTID'];
    ...
    const client = new __1.IpProxyDetectionSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CheckDirect.test.js.map