...
describe("CheckDirect", function()
  it("should direct-load-check", function()
    local setup = check_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-check", setup.live and "live" or "unit")
...
function check_direct_setup(mockres)
