...
function runner.env_override(m)
  local live = runner.getenv("IPPROXYDETECTION_TEST_LIVE")
  local override = runner.getenv("IPPROXYDETECTION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("IPPROXYDETECTION_TEST_EXPLAIN")
