...
type IpProxyDetectionSDK struct {
	Mode     string
...
func (sdk *IpProxyDetectionSDK) OptionsMap() map[string]any {
...
func (sdk *IpProxyDetectionSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpProxyDetectionSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpProxyDetectionSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpProxyDetectionSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpProxyDetectionSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpProxyDetectionSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpProxyDetectionSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpProxyDetectionSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpProxyDetectionSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpProxyDetectionSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpProxyDetectionSDK {
	...
	sdk := NewIpProxyDetectionSDK(sdkopts)
	sdk.Mode = "test"
