...
type CheckEntity struct {
	name    string
	client  *core.IpProxyDetectionSDK
...
func NewCheckEntity(client *core.IpProxyDetectionSDK, entopts map[string]any) *CheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckEntity) GetName() string { return e.name }
...
func (e *CheckEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CheckEntity) Deleted() bool {
	return e.deleted
}


func (e *CheckEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCheckEntity(e.client, opts)
}

func (e *CheckEntity) Data(args ...any) any {
...
func (e *CheckEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Check; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CheckEntity) DataTyped(data ...Check) Check {
	if len(data) > 0 {
		return typedFrom[Check](e.Data(asMap(data[0])))
	}
	return typedFrom[Check](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Check (all fields
// optional at the wire level).
func (e *CheckEntity) MatchTyped(match ...Check) Check {
	if len(match) > 0 {
		return typedFrom[Check](e.Match(asMap(match[0])))
	}
	return typedFrom[Check](e.Match())
}
...
func (e *CheckEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CheckEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CheckLoadMatch and returns an Check. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CheckEntity) LoadTyped(reqmatch CheckLoadMatch, ctrl map[string]any) (Check, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Check{}, err
	}
	return typedFrom[Check](res), nil
}



func (e *CheckEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CheckEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CheckEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CheckEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CheckEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
