...
class CheckEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set IP_PROXY_DETECTION_TEST_CHECK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function check_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("IP_PROXY_DETECTION_TEST_CHECK_ENTID");
    ...
    if ($env["IP_PROXY_DETECTION_TEST_LIVE"] === "TRUE") {
