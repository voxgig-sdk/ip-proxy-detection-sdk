...
// IpProxyDetection SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpProxyDetectionSDK::test)
...
{
    private const SDK_CLASS = 'IpProxyDetectionSDK';
    ...
    private const SDK_BASE = 'ipproxydetection_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipproxydetection_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
