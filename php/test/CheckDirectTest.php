...
class CheckDirectTest extends TestCase
{
    public function test_direct_load_check(): void
    {
        $setup = check_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-check", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
