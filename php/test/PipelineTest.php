...
// IpProxyDetection SDK pipeline test
//
...
{
    private static function utility(): IpProxyDetectionUtility
    {
        return new IpProxyDetectionUtility();
    }
    ...
    private static function ctx(array $over = []): IpProxyDetectionContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new IpProxyDetectionContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new IpProxyDetectionOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof IpProxyDetectionError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new IpProxyDetectionOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = IpProxyDetectionMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new IpProxyDetectionOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = IpProxyDetectionMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new IpProxyDetectionOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = IpProxyDetectionMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpProxyDetectionSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = IpProxyDetectionMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new IpProxyDetectionResponse([]),
            'result' => new IpProxyDetectionResult([]),
        ]);
        [, $err] = IpProxyDetectionMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new IpProxyDetectionSpec([]),
            'response' => null,
            'result' => new IpProxyDetectionResult([]),
        ]);
        [, $err] = IpProxyDetectionMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new IpProxyDetectionSpec(['step' => 's']),
            'response' => new IpProxyDetectionResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new IpProxyDetectionResult([]),
        ]);
        [, $err] = IpProxyDetectionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new IpProxyDetectionSpec(['step' => 's']),
            'response' => new IpProxyDetectionResponse(self::resp(200, ['v' => 1])),
            'result' => new IpProxyDetectionResult([]),
        ]);
        [, $err] = IpProxyDetectionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new IpProxyDetectionSpec(['step' => 's']),
            'response' => new IpProxyDetectionResponse(self::resp(200, ['v' => 2])),
            'result' => new IpProxyDetectionResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        IpProxyDetectionMakeResponse::call($ctx);
    ...
    {
        $preset = new IpProxyDetectionResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new IpProxyDetectionSpec([]),
            'response' => new IpProxyDetectionResponse([]),
            'result' => new IpProxyDetectionResult([]),
        ...
        [$got, $err] = IpProxyDetectionMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new IpProxyDetectionResult([])]);
        [, $err] = IpProxyDetectionMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new IpProxyDetectionSpec([]), 'result' => null]);
        [, $err] = IpProxyDetectionMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpProxyDetectionSpec(['step' => 's']),
            'result' => new IpProxyDetectionResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new IpProxyDetectionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpProxyDetectionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new IpProxyDetectionSpec(['step' => 's']),
            'result' => new IpProxyDetectionResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new IpProxyDetectionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = IpProxyDetectionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new IpProxyDetectionResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new IpProxyDetectionSpec([]),
            'result' => new IpProxyDetectionResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = IpProxyDetectionMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpProxyDetectionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new IpProxyDetectionError('boom', 'boom');
        $utility->fetcher = function (IpProxyDetectionContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpProxyDetectionSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = IpProxyDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (IpProxyDetectionContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = IpProxyDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(IpProxyDetectionResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        IpProxyDetectionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (IpProxyDetectionContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new IpProxyDetectionSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = IpProxyDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new IpProxyDetectionResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new IpProxyDetectionSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = IpProxyDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = IpProxyDetectionMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = IpProxyDetectionMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new IpProxyDetectionResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, IpProxyDetectionDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new IpProxyDetectionResult(['ok' => false])]);
        $this->expectException(IpProxyDetectionError::class);
        IpProxyDetectionDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new IpProxyDetectionResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', IpProxyDetectionMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        IpProxyDetectionMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new IpProxyDetectionBaseFeature();
        $b = new IpProxyDetectionBaseFeature();
        IpProxyDetectionFeatureAdd::call($ctx, $a);
        IpProxyDetectionFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): IpProxyDetectionBaseFeature
    {
        $f = new IpProxyDetectionBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        IpProxyDetectionFeatureAdd::call($ctx, self::named_feature('a'));
        IpProxyDetectionFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        IpProxyDetectionFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        IpProxyDetectionFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        IpProxyDetectionFeatureAdd::call($ctx, $replace);
        ...
        IpProxyDetectionFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?IpProxyDetectionSpec $spec): IpProxyDetectionContext
    {
    ...
    private static function auth_bags(): IpProxyDetectionSpec
    {
        return new IpProxyDetectionSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        IpProxyDetectionPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = IpProxyDetectionPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new IpProxyDetectionResponse(['headers' => null]),
            'result' => new IpProxyDetectionResult([]),
        ]);
        IpProxyDetectionResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        IpProxyDetectionResultBody::call($ctx);
