...
// IpProxyDetection SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpProxyDetectionTransformResponse
{
    public static function call(IpProxyDetectionContext $ctx): mixed
    {
        ...
        $transform = IpProxyDetectionHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
