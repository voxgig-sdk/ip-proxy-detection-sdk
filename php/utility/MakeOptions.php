...
// IpProxyDetection SDK utility: make_options

class IpProxyDetectionMakeOptions
{
    ...
    public static function call(IpProxyDetectionContext $ctx): array
    {
        ...
        //
        // `IpProxyDetectionSchema::optspec()` is built from the model:
        ...
        $optspec = IpProxyDetectionSchema::optspec();
