...
// IpProxyDetection SDK utility type

class IpProxyDetectionUtility
{
    ...
    public static function copy(IpProxyDetectionUtility $src): IpProxyDetectionUtility
    {
        $u = new IpProxyDetectionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
