...
// IpProxyDetection SDK idempotency feature
...
class IpProxyDetectionIdempotencyFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _mutating(IpProxyDetectionContext $ctx): bool
    {
