...
// IpProxyDetection SDK debug feature
...
class IpProxyDetectionDebugFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _finish(IpProxyDetectionContext $ctx, bool $ok): void
    {
