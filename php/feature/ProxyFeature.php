...
// IpProxyDetection SDK proxy feature
...
class IpProxyDetectionProxyFeature extends IpProxyDetectionBaseFeature
{
    ...
    public function init(IpProxyDetectionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpProxyDetectionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
