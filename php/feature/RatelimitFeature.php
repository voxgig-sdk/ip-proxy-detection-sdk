...
// IpProxyDetection SDK ratelimit feature
...
class IpProxyDetectionRatelimitFeature extends IpProxyDetectionBaseFeature
{
    ...
    private function _acquire(IpProxyDetectionContext $ctx): void
    {
    ...
    private function _track(IpProxyDetectionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
