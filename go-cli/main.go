// Command IpProxyDetection-cli is a CLI + REPL for the IpProxyDetection SDK,
...
const prompt = "ip-proxy-detection"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "check"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      IP_PROXY_DETECTION_APIKEY (api key), IP_PROXY_DETECTION_BASE (base url override)")
