...
func registerSDKWords(r *eng.Registry, client *sdk.IpProxyDetectionSDK) {
...
func runOp(client *sdk.IpProxyDetectionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
